          ...
          <div className="text-center mx-auto">
            <div className="space-y-3">
              ...
              <Paragraph>
                ...
                <span className="text-primary">1924. godine</span>. Odlukom Vlade za Bosnu i Hercegovinu broj:8636/45 od{' '}
              ...
              <Paragraph>
                ...
                odjeljenja prvih razreda. Nekada se zvala Centar za srednjoškolsko obrazovanje{' '}
              ...
              <Paragraph>
                ...
                odjeljenja medicinske struke- smjer medicinska sestra/tehničar. Gimnazija je odavno postala brend grada
                Bugojna, a kroz nju su prošli mnogi danas <span className="text-primary">znameniti ljudi</span>: doktori
                nauka, naučnici, ljekari, profesori, inženjeri, umjetnici i ostali koji danas obavljaju poslove u Bosni
                i Hercegovini, te u mnogim zemljama širom svijeta.
              </Paragraph>
            </div>
