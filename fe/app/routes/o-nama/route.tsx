  ...
  return (
    <>
      ...
      <main className="relative">
        <SectionPageTitle subtitle="Više od pola stoljeća tradicije i obrazovanja. Mjesto gdje prošlost susreće budućnost, gdje se oblikuju generacije lidera i gdje znanje postaje temelj za životne uspjehe. Naša gimnazija nije samo obrazovna institucija, već i inspiracija za učenike da postanu najbolja verzija sebe i ostave trag u svijetu.">
          O nama
        </SectionPageTitle>
        <SectionChecklist />
        <SectionHistory />
