...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="group absolute right-6 top-6 flex h-8 w-8 items-center justify-center rounded-full border ring-offset-white transition-colors hover:border-transparent hover:bg-primary focus:border-transparent focus:bg-primary disabled:pointer-events-none data-[state=open]:bg-slate-100 dark:bg-white/[.15] dark:hover:bg-primary dark:data-[state=open]:bg-slate-800">
        <svg
